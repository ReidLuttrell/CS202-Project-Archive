...
int main() {
    ...
    std::cout << "For live rooms, reply is disabled.\nFor private rooms, only the two members can join.\nFor message boards, reply is disabled.\nThis is done through virtual overriding.\n\n";
